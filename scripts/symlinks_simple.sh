...
ln -sf ~/hyprtekdots/configs/hyfetch.json ~/.config/hyfetch.json
ln -sf ~/hyprtekdots/configs/wofi/style.css ~/.config/wofi/style.css
ln -sf ~/hyprtekdots/configs/kitty/kitty.conf ~/.config/kitty/kitty.conf 
ln -sf ~/hyprtekdots/configs/kitty/current-theme.conf ~/.config/kitty/current-theme.conf 
ln -sf ~/hyprtekdots/configs/hyprpanel/config.json ~/.config/hyprpanel/config.json
